        <div class="card">
         ...
         <div class="card">
            ...
            <div class="card-body">
                ...
                <input type="text" hidden name="curso" value="@if(old('curso') == '' and $agendamento->curso == ''){{ $graduacao::curso(Auth::user()->codpes,getenv('REPLICADO_CODUNDCLG'))['nomcur'] }} @else {{$graduacao::curso($agendamento->user->codpes,getenv('REPLICADO_CODUNDCLG'))['nomcur']}} @endif">
                <div class="form-group">
